...
export default function WithSubnavigation() {
  ...
  const [currentContract, setCurrentContract] = useRecoilState(contractAtom);

  const options = whitelist.map(contract => {
    const current = contractsDetails[contract.toString()];
    return {
      label: contract,
